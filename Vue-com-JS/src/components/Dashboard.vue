<template>
  <div class="min-h-screen bg-linear-to-br from-gray-100 to-gray-200 p-8 rounded-lg">
    <div class="max-w-7xl mx-auto space-y-6">
              ...
              <div class="flex items-end gap-4 w-full md:w-auto md:flex-row flex-col">
                <div class="w-full">
                  ...
                  <div class="flex gap-2">
                    <select v-model="filters.province" class="flex-1 px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none">
      ...
      <div class="bg-white rounded-2xl shadow-lg p-6 text-center text-gray-600 flex items-center justify-around  flex-col md:flex-row gap-8">
        ...
        <div class="flex flex-col items-center justify-center">
          <div class="mt-2">
            Desenvolvido com Vue 3, JavaScript e Tailwind CSS.
          </div>
          <div class="mt-2">
        ...
        <div class="flex items-center justify-center gap-2">
          <a 
            ...
            class="flex items-center justify-center gap-2 hover:opacity-80 transition-opacity"
          >
            <img :src="LogoJS" alt="JavaScript Logo" class="w-10 h-10" />
